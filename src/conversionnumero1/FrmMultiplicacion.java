...
public class FrmMultiplicacion extends javax.swing.JFrame {
    ...
    private static FrmMultiplicacion obj=null;
    
    private FrmMultiplicacion() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
        btnmulti.setIcon(setIcono("/Imagenes/multi1.png",btnmulti));
    }
    
    public static FrmMultiplicacion getObj(){
        if(obj==null){
            obj=new FrmMultiplicacion();
        }return obj;
    }
